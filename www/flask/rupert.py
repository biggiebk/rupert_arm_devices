...
def sleep():
  control_dictionary = { "event_type": "control", "name": "Bedroom Light", "cycle": "descend", "red": 0, "green": 0, "blue": 255, "duration": 600, "increment": 1, "return_topic": "debug_topic"}
  kafka_producer = Synapse('/web/cfg/settings.json')
  kafka_producer.send("devcies_alpha",json.dumps(control_dictionary))
  return f"Sleeping"
...
def wakeup():
  control_dictionary = { "event_type": "control", "name": "Bedroom Light", "cycle": "custom", "cycle_name": "wake_up", "return_topic": "debug_topic"}
  kafka_producer = Synapse('/web/cfg/settings.json')
  kafka_producer.send("devcies_alpha",json.dumps(control_dictionary))
  return f"Waking Up"
